...
class RequestControllerTest extends BaseIntegrationTest {
    ...
    @Test
    @Order(1)
    @DisplayName("GET /request/customer - Danh sach yeu cau (public)")
    ...
    @Test
    @Order(2)
    @DisplayName("POST /request - Gui yeu cau thue phong")
    void submitRentalRequest() throws Exception {
        String token = getAuthToken();
        String requestJson = "{\"roomId\": 1, \"phone\": \"0912345678\", \"nameOfRent\": \"Test User\"}";
    ...
    @Test
    @Order(3)
    @DisplayName("GET /request - Danh sach yeu cau (rentaler)")
    ...
    @Test
    @Order(4)
    @DisplayName("GET /request/customer - Khong can xac thuc")
